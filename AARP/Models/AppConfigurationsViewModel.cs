...
namespace AARP.Models
{
    public class AppConfigurationsViewModel
    {
        ...
        public AARP.Services.AppConfigs.RecruiterBoxConfigs RecruiterBox { get; set; }
        ...
        public AppConfigurationsViewModel()
        {
            ...
            this.RecruiterBox = AppConfigsProvider.GetConfigs<AARP.Services.AppConfigs.RecruiterBoxConfigs>();
        }
        ...
        public void SaveChanges()
        {
           ...
           AppConfigsProvider.SaveConfigs<AARP.Services.AppConfigs.RecruiterBoxConfigs>(this.RecruiterBox);
        }
    }
}